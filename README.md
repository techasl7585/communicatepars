...
CommunicatePars, Pardus GNOME işletim sistemi için geliştirilen açık kaynaklı bir cihaz entegrasyon uygulamasıdır. Android, iOS ve diğer ağ cihazlarıyla dosya paylaşımı, ekran yansıtma, uzaktan kontrol ve ikinci ekran gibi özellikleri tek bir arayüz altında sunmayı amaçlar.
